            ...
            <div className="bg-gray-800/50 rounded-xl p-6 border border-gray-700/50">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-gray-700/60 border border-gray-600 rounded-lg p-3">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {campaigns.map((c) => (
                      <span key={c.Id} className="text-xs bg-gray-800 px-2 py-1 rounded border border-gray-700">
                        {c.Name.replace(/WalmartCreator\.com/i, 'Walmart')}
                      </span>
                    ))}
                    {campaigns.length === 0 && (
                      <span className="text-xs text-gray-400">No brands available yet</span>
                    )}
                  </div>
                </div>
                <button
                  onClick={createLink}
                  className="w-full bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 px-6 py-3 rounded-lg font-medium transition-all duration-200 transform hover:scale-105"
                >
                  🔗 Generate Link
                </button>
                ...
                {generatedLink && (
                  <div className="mt-4 p-4 bg-green-500/10 border border-green-500/30 rounded-lg">
                    <div className="flex items-center justify-between mb-2">
                      <h4 className="text-sm font-medium text-green-400">✅ New Affiliate Link Generated</h4>
                      <button
                        onClick={() => setGeneratedLink(null)}
                    ...
                    <div className="space-y-2">
                      <div>
                        <label className="text-xs text-gray-400">Short Code:</label>
                        <p className="text-sm text-purple-300 font-mono">/{generatedLink.shortCode}</p>
                      </div>
                      <div>
                        ...
                        <div className="flex items-center space-x-2 mt-1">
                          ...
                          <button
                            onClick={() => copyToClipboard(generatedLink.affiliateLink)}
                            className="bg-purple-600 hover:bg-purple-700 px-3 py-2 rounded text-sm transition-colors duration-200 whitespace-nowrap"
                          >
                            📋 Copy
                          </button>
                        </div>
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-500 truncate">{generatedLink.originalUrl}</p>
                      </div>
                    </div>
                  </div>
                )}
